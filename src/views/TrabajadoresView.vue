...
onMounted(() => {
  ...
  }, 1000); // Tiempo para esperar la carga de datos

});

onUnmounted(() => {
  if (dataTableInstance) {
    dataTableInstance.destroy(); // Destruir instancia de DataTable cuando el componente se desmonte
...
<div class="w-full p-5 space-y-5">
    ...
    <Transition appear mode="out-in" name="slide-up">
      ...
      <div v-else>  
        <table v-if="trabajadores.trabajadores.length > 0" id="customTable" class="table table-hover table-striped">
            <thead>
                <tr>
                  <th>#</th>
                  <th>Nombre</th>

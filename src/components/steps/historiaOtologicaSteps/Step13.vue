...
onMounted(() => {
    if (documentos.currentDocument) {
        ...
        diabetes.value = formDataHistoriaOtologica.diabetes || 'NO';
    }
});

onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para diabetes
    if (!formDataHistoriaOtologica.diabetes) {
        formDataHistoriaOtologica.diabetes = diabetes.value;
    }
});

// Sincronizar diabetes con formData
watch(diabetes, (newValue) => {
    formDataHistoriaOtologica.diabetes = newValue;
});
</script>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div 
                        :class="[
                            ...
                            diabetes === 'NO' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                    ...
                    <span 
                        :class="[
                            ...
                            diabetes === 'NO' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        NO
                    </span>
                ...
                >
                    ...
                    <div 
                        :class="[
                            'w-8 h-8 rounded-full flex items-center justify-center mb-1.5 transition-colors duration-200',
                            diabetes === 'SI' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span 
                        :class="[
                            'text-base font-semibold transition-colors duration-200',
                            diabetes === 'SI' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        SÍ
                    </span>

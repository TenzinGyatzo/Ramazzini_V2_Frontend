...
const textoBase = computed(() => {
    ...
    let texto = `${sexo === 'Femenino' ? 'La trabajadora' : 'El trabajador'} presenta`;
    ...
    <div class="mb-4">
        ...
        <div v-if="trabajadores.currentTrabajador.sexo === 'Femenino'" class="mb-4">
            ...
            <div class="space-y-2">
                ...
                <!-- Contenedor del desplegable -->
                <div v-if="isOpen('guiaEvaluacionNoCompletada')" class="font-medium space-y-2 p-4 border rounded-md shadow-sm bg-white">
                    <div class="p-4 border-l-4 border-gray-500 bg-gray-100">
                        ...
                        <ul class="list-disc list-inside">
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('debido a que no es posible saber si ')">
                                    debido a que no es posible saber si...
                                </p>
                            </li>
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('puesto que no se dispone de información suficiente sobre ')">
                                    puesto que no se dispone de información suficiente sobre...
                                </p>
                            </li>
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('ya que el trabajador tiene una condición que podría implicar ')">
                        ...
                        <p class="font-semibold text-sm font-light text-gray-700">Ejemplos de inicio de indicaciones:</p>
                        <ul class="list-disc list-inside">
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('Es necesario realizar una evaluación detallada de ')">
                                    Es necesario realizar una evaluación detallada de...
                                </p>
                            </li>
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('Es imperativo que el candidato se someta a una evaluación de ')">
                                    Es imperativo que el candidato se someta a una evaluación de...
                                </p>
                            </li>
                            <li class="text-gray-700 hover:text-blue-700 cursor-pointer leading-4">
                                <p class="italic text-sm font-light inline" @click="copiarTexto('Es esencial que el candidato complete un programa de rehabilitación física de ')">

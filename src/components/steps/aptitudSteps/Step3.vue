...
watch(pregunta, () => {
    if (pregunta.value === 'No') {
        formDataAptitud.evaluacionAdicional2 = null;
        formDataAptitud.fechaEvaluacionAdicional2 = null;
        formDataAptitud.resultadosEvaluacionAdicional2 = null;
    } else {
        formDataAptitud.evaluacionAdicional2 = formDataAptitud.evaluacionAdicional2 || '';
        formDataAptitud.fechaEvaluacionAdicional2 = formDataAptitud.fechaEvaluacionAdicional2 || today;
        formDataAptitud.resultadosEvaluacionAdicional2 = formDataAptitud.resultadosEvaluacionAdicional2 || '';
    }
});
</script>
...
<template>
    ...
    <!-- Pregunta principal -->
    <div class="mb-4">
        <p class="font-medium mb-1 text-gray-800 leading-5">¿Agregar evaluación adicional 2?
        </p>

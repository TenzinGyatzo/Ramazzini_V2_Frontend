...
onUnmounted(() => {
  ...
  formDataControlPrenatal.eneroFondoUterino = eneroFondoUterino.value ? parseFloat(eneroFondoUterino.value) : null;
});
...
watch(eneroFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.eneroFondoUterino = fondoUterinoNum;
});

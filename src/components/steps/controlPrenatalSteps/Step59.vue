...
onUnmounted(() => {
  ...
  formDataControlPrenatal.agostoFondoUterino = agostoFondoUterino.value ? parseFloat(agostoFondoUterino.value) : null;
});
...
watch(agostoFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.agostoFondoUterino = fondoUterinoNum;
});

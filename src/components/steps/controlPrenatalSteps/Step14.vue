...
onMounted(() => {
  // Verificar si formDataControlPrenatal tiene valores para enero y establecerlos
  if (formDataControlPrenatal.eneroTia) {
    // Extraer sistólica y diastólica del formato "120/80"
    const tensionCompleta = formDataControlPrenatal.eneroTia;

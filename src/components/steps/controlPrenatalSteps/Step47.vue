...
onUnmounted(() => {
  ...
  formDataControlPrenatal.junioFondoUterino = junioFondoUterino.value ? parseFloat(junioFondoUterino.value) : null;
});
...
watch(junioFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.junioFondoUterino = fondoUterinoNum;
});

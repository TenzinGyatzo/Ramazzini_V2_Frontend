...
onUnmounted(() => {
  ...
  formDataControlPrenatal.mayoFondoUterino = mayoFondoUterino.value ? parseFloat(mayoFondoUterino.value) : null;
});
...
watch(mayoFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.mayoFondoUterino = fondoUterinoNum;
});

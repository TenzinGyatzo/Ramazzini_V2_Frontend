...
onMounted(() => {
  // Verificar si formDataControlPrenatal.abrilSdg tiene un valor y establecerlo
  if (formDataControlPrenatal.abrilSdg) {
    abrilSdg.value = formDataControlPrenatal.abrilSdg.toString();
  }
});
...
const categoriaGestacionComputed = computed(() => {
  return determinarCategoriaGestacion(abrilSdg.value);
});
...
const mensajeErrorSemana = computed(() => {
  if (!abrilSdg.value || abrilSdg.value === '') return '';
  
  const semana = parseInt(abrilSdg.value);
...
<template>
  <div>
      ...
      <div class="mb-4">
        ...
        <div class="mb-4 mt-4">
          <div class="grid grid-cols-4 gap-3">
            <button
              ...
              :class="abrilSdg === preset.valor.toString() 
        ...
        <div class="mb-4">
          <div class="flex items-center justify-center gap-3">
            <label for="abrilSdg" class="font-medium text-gray-700">Personalizar:</label>
            <input
              id="abrilSdg"
              v-model="abrilSdg"
              type="number"
    ...
    <div class="mb-6">
      <div v-if="abrilSdg && !mensajeErrorSemana" class="mb-4">
      ...
      <div v-else-if="abrilSdg && mensajeErrorSemana" class="p-3 bg-red-50 border border-red-200 rounded-lg">

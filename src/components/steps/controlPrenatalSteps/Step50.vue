...
onMounted(() => {
  // Verificar si formDataControlPrenatal tiene valores para julio y establecerlos
  if (formDataControlPrenatal.julioTia) {
    // Extraer sistólica y diastólica del formato "120/80"
    const tensionCompleta = formDataControlPrenatal.julioTia;

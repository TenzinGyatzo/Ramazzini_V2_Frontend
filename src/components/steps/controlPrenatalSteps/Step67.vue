...
onUnmounted(() => {
  ...
  formDataControlPrenatal.octubrePeso = octubrePeso.value ? parseFloat(octubrePeso.value) : null;
  formDataControlPrenatal.octubreImc = octubreImc.value ? parseFloat(octubreImc.value) : null;
...
watch(octubrePeso, (newValue) => {
  ...
  formDataControlPrenatal.octubrePeso = pesoNum;
  ...
  if (newValue && alturaDisponible.value) {
    ...
    formDataControlPrenatal.octubreImc = imcCalculado ? parseFloat(imcCalculado) : null;
  } else {
    octubreImc.value = '';
    formDataControlPrenatal.octubreImc = null;
  }
});
  ...
  <div>
    ...
    <div class="mb-6">
      ...
      <div class="mb-4 grid grid-cols-2 gap-2">
        <div v-if="octubrePeso" class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
        ...
        <div>
          ...
          <div v-else-if="octubreImc" class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              <p class="text-xs text-emerald-800 mb-2">

...
onMounted(() => {
  // Verificar si formDataControlPrenatal.mayoFcf tiene un valor y establecerlo
  if (formDataControlPrenatal.mayoFcf) {
    mayoFcf.value = formDataControlPrenatal.mayoFcf.toString();
  }
});
...
const categoriaFcfComputed = computed(() => {
  return determinarCategoriaFcf(mayoFcf.value);
});

// Validaciones reactivas
const mensajeErrorFcf = computed(() => {
  if (!mayoFcf.value || mayoFcf.value === '') return '';
  
  const fcf = parseInt(mayoFcf.value);
...
<template>
  <div>
    ...
    <div class="mb-4">
      ...
      <div class="mb-4 mt-4">
        <div class="grid grid-cols-5 gap-3">
          <button
            ...
            :class="mayoFcf === preset.valor.toString() 
      ...
      <div class="mb-4">
        <div class="flex items-center justify-center gap-3">
          <label for="mayoFcf" class="font-medium text-gray-700">Personalizar:</label>
          <input
            id="mayoFcf"
            v-model="mayoFcf"
            type="number"
    ...
    <div class="mb-6">
      ...
      <div v-else-if="mayoFcf && mensajeErrorFcf" class="p-3 bg-red-50 border border-red-200 rounded-lg">

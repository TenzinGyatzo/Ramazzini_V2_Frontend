...
onUnmounted(() => {
  ...
  formDataControlPrenatal.marzoFondoUterino = marzoFondoUterino.value ? parseFloat(marzoFondoUterino.value) : null;
});
...
watch(marzoFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.marzoFondoUterino = fondoUterinoNum;
});

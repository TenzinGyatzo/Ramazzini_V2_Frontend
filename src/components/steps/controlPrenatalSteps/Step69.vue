...
onUnmounted(() => {
  ...
  formDataControlPrenatal.septiembrePeso = septiembrePeso.value || '';
  formDataControlPrenatal.septiembreImc = septiembreImc.value || '';
...
watch(septiembrePeso, (newValue) => {
  formDataControlPrenatal.septiembrePeso = newValue;
  ...
  if (newValue && alturaDisponible.value) {
    ...
    formDataControlPrenatal.septiembreImc = imcCalculado;
  } else {
    septiembreImc.value = '';
    formDataControlPrenatal.septiembreImc = '';
  }
});
...
<template>
  <div>
    ...
    <div class="mb-6">
      ...
      <p class="font-medium mb-2 text-gray-800 leading-5">¿Cuál fue el peso registrado durante el control prenatal del mes de septiembre?</p>
    ...
    <div class="mb-6">
      ...
      <div v-else-if="septiembreImc" class="mt-1 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
          <p class="text-sm text-emerald-700">
              ✅ IMC calculado: <span class="font-semibold">{{ septiembreImc }}</span>
          </p>
      </div>

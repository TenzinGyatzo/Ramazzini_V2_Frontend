...
onUnmounted(() => {
  ...
  formDataControlPrenatal.abrilFondoUterino = abrilFondoUterino.value ? parseFloat(abrilFondoUterino.value) : null;
});
...
watch(abrilFondoUterino, (newValue) => {
  ...
  formDataControlPrenatal.abrilFondoUterino = fondoUterinoNum;
});

...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para cicatricesPregunta
...
// Sincronizar cicatricesPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando cicatricesPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(cicatricesPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.cicatrices = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

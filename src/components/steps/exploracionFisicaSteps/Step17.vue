...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para caderaPregunta
...
// Sincronizar caderaPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando caderaPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(caderaPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.cadera = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

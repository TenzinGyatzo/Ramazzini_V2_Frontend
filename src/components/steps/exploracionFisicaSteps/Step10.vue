...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para hombrosPregunta
...
// Sincronizar hombrosPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando hombrosPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(hombrosPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.hombros = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para vascularESuperioresPregunta
...
// Sincronizar vascularESuperioresPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando vascularESuperioresPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(vascularESuperioresPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.vascularESuperiores = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para coordinacionPregunta
...
// Sincronizar coordinacionPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando coordinacionPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(coordinacionPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.coordinacion = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

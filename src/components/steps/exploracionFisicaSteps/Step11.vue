...
onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para codosPregunta
...
// Sincronizar codosPregunta con formData
...
// Watch para establecer 'Sin hallazgos' cuando codosPregunta sea 'No' y enfocar textarea cuando sea 'Si'
watch(codosPregunta, async (newValue) => {
    if (newValue === 'No') {
        formDataExploracionFisica.codos = 'Sin hallazgos';
    }
    if (newValue === 'Si') {

...
onMounted(() => {
    ...
    hemoptisis.value = formDataPrevioEspirometria.hemoptisis || 
                       documentos.currentDocument?.hemoptisis || 
                       'NO';
});

onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para hemoptisis
    if (!formDataPrevioEspirometria.hemoptisis) {
        formDataPrevioEspirometria.hemoptisis = hemoptisis.value;
    }
});

// Sincronizar hemoptisis con formData
watch(hemoptisis, (newValue) => {
    formDataPrevioEspirometria.hemoptisis = newValue;
});
</script>
...
<template>
    <div>
        ...
        <div class="mb-8">
            <p class="text-lg font-medium mb-4 text-gray-800">¿El trabajador sufre de hemoptisis?</p>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div 
                        :class="[
                            ...
                            hemoptisis === 'NO' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                    ...
                    <span 
                        :class="[
                            ...
                            hemoptisis === 'NO' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        NO
                    </span>
                ...
                >
                    ...
                    <div 
                        :class="[
                            'w-8 h-8 rounded-full flex items-center justify-center mb-1.5 transition-colors duration-200',
                            hemoptisis === 'SI' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span 
                        :class="[
                            'text-base font-semibold transition-colors duration-200',
                            hemoptisis === 'SI' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        SÍ
                    </span>

...
onMounted(() => {
    ...
    tosCronica.value = formDataPrevioEspirometria.tosCronica || 
                       documentos.currentDocument?.tosCronica || 
                       'NO';
});

onUnmounted(() => {
    // Asegurar que formData tenga un valor inicial para tosCronica
    if (!formDataPrevioEspirometria.tosCronica) {
        formDataPrevioEspirometria.tosCronica = tosCronica.value;
    }
});

// Sincronizar tosCronica con formData
watch(tosCronica, (newValue) => {
    formDataPrevioEspirometria.tosCronica = newValue;
});
</script>
...
<template>
    <div>
        ...
        <div class="mb-8">
            <p class="text-lg font-medium mb-4 text-gray-800">¿El trabajador sufre de tos crónica?</p>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div 
                        :class="[
                            ...
                            tosCronica === 'NO' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                    ...
                    <span 
                        :class="[
                            ...
                            tosCronica === 'NO' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        NO
                    </span>
                ...
                >
                    ...
                    <div 
                        :class="[
                            'w-8 h-8 rounded-full flex items-center justify-center mb-1.5 transition-colors duration-200',
                            tosCronica === 'SI' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span 
                        :class="[
                            'text-base font-semibold transition-colors duration-200',
                            tosCronica === 'SI' ? 'text-emerald-700' : 'text-gray-700'
                        ]"
                    >
                        SÍ
                    </span>

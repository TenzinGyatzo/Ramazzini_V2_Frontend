...
const handleClick = async () => {
  ...
  try {
    ...
    a.href = url;
    a.download = `${trabajadores.currentTrabajador.primerApellido} ${trabajadores.currentTrabajador.segundoApellido} ${trabajadores.currentTrabajador.nombre} ${today.getDate()}-${today.getMonth() + 1}-${today.getFullYear()}.pdf`;

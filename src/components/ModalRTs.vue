        ...
        <div v-if="modo === 'nuevo' || modo === 'editar'" class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" v-model="rtEnEdicion.naturalezaLesion" placeholder="Descripción de la lesión" class="w-full p-3 border rounded-lg focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500" list="nat-lesion-sugerencias" />
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" v-model="rtEnEdicion.NSS" placeholder="Número de Seguridad Social" class="w-full p-3 border rounded-lg focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500" />

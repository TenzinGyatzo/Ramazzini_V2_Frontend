  ...
  <Transition name="fade">
    <div class="relative z-10" role="dialog">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div @click="$emit('closeModal')" class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <Transition name="fade">
            <div class="modal-inner relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">

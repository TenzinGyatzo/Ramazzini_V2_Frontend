<script setup>
    ...
    const handleDelete = () => {
        empresas.deleteEmpresaById(idEmpresa);
        emit('closeModal');
    ...
    <Transition name="fade">
        <div class="relative z-10" role="dialog">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0" @click="$emit('closeModal')">
                    <Transition name="slide-up">
                        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                                        <svg class="h-6 w-6 text-red-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon">
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">Parece que quieres eliminar la empresa "{{ nombreComercial || 'Nombre no disponible' }}"</p>

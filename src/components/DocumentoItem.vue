...
<template>
    <div
        ...
        <div class="flex items-center">
            ...
            <div v-if="typeof antidoping === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-32 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Antidoping</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(antidoping.fechaAntidoping) }}</p>
                </div>
            ...
            <div v-if="typeof aptitud === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-32 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Aptitud al Puesto</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(aptitud.fechaAptitudPuesto) }}</p>
                </div>
                <div class="flex gap-2 md:block hidden">
                    <div class="w-72">
            ...
            <div v-if="typeof certificado === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-32 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Certificado</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(certificado.fechaCertificado) }}</p>
                </div>
                <div class="flex gap-2 md:block hidden">    
                    <div class="w-72">
            ...
            <div v-if="typeof documentoExterno === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-32 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">{{ documentoExterno.nombreDocumento }}</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(documentoExterno.fechaDocumento) }}</p>
                </div>
                <div class="flex gap-2 md:block hidden">
                    <div class="min-w-72">
                        <p class="leading-5 text-sm px-1">Notas:</p>
            ...
            <div v-if="typeof examenVista === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-30 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Examen de la Vista</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(examenVista.fechaExamenVista) }}</p>
                </div>
                <div v-if="!examenVista.ojoIzquierdoLejanaConCorreccion && !examenVista.ojoDerechoLejanaConCorreccion" class="flex gap-2 md:block hidden">
                    <div class="w-72 md:block hidden">
                        <p class="leading-5 text-sm px-1">Resultados:</p>
                        <p 
                            class="leading-5 font-semibold text-gray-800 px-1"
            ...
            <div v-if="typeof exploracionFisica === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-30 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Exploración Física</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(exploracionFisica.fechaExploracionFisica) }}</p>
                </div>
            ...
            <div v-if="typeof historiaClinica === 'object'" class="my-1 mx-1 flex gap-2">
                <div class="min-w-30 sm:min-w-44">
                    <p class="leading-5 text-lg sm:text-xl font-medium">Historia Clínica</p>
                    <p class="leading-5 text-sm sm:text-base text-gray-500">{{ convertirFechaISOaDDMMYYYY(historiaClinica.fechaHistoriaClinica) }}</p>
                </div>
                <div class="flex gap-2">
                    <div class="w-72 xl:block hidden">
        ...
        <div class="flex gap-1 sm:gap-1 md:gap-2 lg:gap-4 mx-2">
           <button type="button" class="py-1 px-1.5 sm:py-2 sm:px-2.5 rounded-full bg-green-100 hover:bg-green-200 text-green-600 transition-transform duration-200 ease-in-out transform hover:scale-110 shadow-sm">
                <i class="fa-solid fa-download fa-lg"></i>
            </button>
            <button type="button" class="py-1 px-1.5 sm:py-2 sm:px-2.5 rounded-full bg-sky-100 hover:bg-sky-200 text-sky-600 transition-transform duration-200 ease-in-out transform hover:scale-110 shadow-sm">
                <i class="fa-regular fa-pen-to-square fa-lg"></i>
            </button>
            <button type="button" class="py-1 px-1.5 sm:py-2 sm:px-2.5 rounded-full bg-red-100 hover:bg-red-200 text-red-600 transition-transform duration-200 ease-in-out transform hover:scale-110 shadow-sm">
